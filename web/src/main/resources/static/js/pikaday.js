...
(function(window, document, undefined)
{
    ...
    renderTitle = function(instance)
    {
        var i, j, arr,
            ...
            months = opts.i18n.monthsShort ? opts.i18n.months : opts.i18n.monthsShort;
        ...
        html += '<div class="pika-label pika-label-year">' + year + '<select class="pika-select pika-select-year">' + arr.join('') + '</select></div>';
        ...
        html += '<div class="pika-label pika-label-month">' + months[month] + '<select class="pika-select pika-select-month">' + arr.join('') + '</select></div>';
